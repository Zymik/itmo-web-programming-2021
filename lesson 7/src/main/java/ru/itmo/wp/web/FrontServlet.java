...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        try {
            runMethod(page, before, request, view);
            runMethod(page, method, request, view);
            runMethod(page, after, request, view);
    ...
    private void runMethod(Object page, Method method, HttpServletRequest request,
                           Map<String, Object> view) throws ServletException, RedirectException {
        try {
    ...
    private static final class Route {
        ...
        private static Route newIndexRoute(String action) {
            return new Route(
                    IndexPage.class.getName(), action
            );
        }
