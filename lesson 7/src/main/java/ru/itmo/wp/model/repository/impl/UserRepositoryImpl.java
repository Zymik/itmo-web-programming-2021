...
public class UserRepositoryImpl extends AbstractRepository<User> implements UserRepository {
    ...
    private final static String CAN_NOT_UPDATE_ERROR = "Can't update User.";
    ...
    public void changeAdminStatus(long userId, boolean status) {
        ...
        update("UPDATE User SET admin=? WHERE id=?", patternFiller, CAN_NOT_UPDATE_ERROR);
    }
    ...
    public boolean contains(long id) {
        ...
        return countBy("SELECT COUNT(*) FROM `User` WHERE id=?", filler, CAN_NOT_FIND_ERROR) >= 1;
    }
}
